...
import LoadingScreen from "../../../../client/Components/Sub/Loader.jsx";
...
describe("<LoadingScreen />", () => {
    ...
    it("matches rotating-plane snapshot", () => {
        const tree = Renderer(<LoadingScreen loadingType="rotating-plane" />);
        expect(tree).toMatchSnapshot();
    });

    it("matches double-bounce snapshot", () => {
        const tree = Renderer(<LoadingScreen loadingType="double-bounce" />);
        expect(tree).toMatchSnapshot();
    });

    it("matches rectangle-bounce snapshot", () => {
        const tree = Renderer(<LoadingScreen loadingType="rectangle-bounce" />);
        expect(tree).toMatchSnapshot();
    });
});
